...
# rm -f ./install-gnome.sh && rm -rf ./.install_gnome && wget https://wobbo.org/install/2026-03-28/install-gnome.sh && chmod +x install-gnome.sh && ./install-gnome.sh
...
printf "  Ubuntu-styled workstation. 2026-03-28\n"
printf "\n"
...
sleep 1
# Het kader
printf "  â•”â•â•â•â•â•â•â•â•â•â•â•â•â• \033[1mGUIDE GNOME â€“ Bootstrap\033[0m â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘   Initializes a secure workspace to store             â•‘\n"
printf "  â•‘   temporary installation files:                       â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•Ÿâ”€â–« \033[3m.install_gnome/state\033[0m                                â•‘\n"
printf "  â•Ÿâ”€â–« \033[3m.install_gnome/step1.sh\033[0m                             â•‘\n"
printf "  â•Ÿâ”€â–« \033[3m.install_gnome/step2.sh\033[0m                             â•‘\n"
printf "  â•Ÿâ”€â–« \033[3m.install_gnome/step3.sh\033[0m                             â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘   Note: Installation files are automatically          â•‘\n"
printf "  â•‘   deleted after the process finishes.                 â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•™â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•œ\n"
printf "\n"
sleep 1

printf "    â–« Creating installer directory:\n"
...
clear
printf "\n\n"
printf "  â•”â•â•â•â•â•â•â• \033[1mGUIDE GNOME Installer â€“ Step 1 of 3\033[0m â•â•â•â•â•â•â•â•â•â•â•â•—\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•Ÿâ”€â–« Sets your system-wide display name for the login    â•‘\n"
printf "  â•‘   screen, desktop, and applications.                  â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•Ÿâ”€â–« Configures the fundamental system language and      â•‘\n"
printf "  â•‘   region for both the terminal and GNOME.             â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•™â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•œ\n"
printf "\n"

printf "    â–¹ Current user: \033[1m$USER\033[0m\n"
printf "\n"

# --- Ask for full name (editable, pre-filled) ---
CURRENT_FULLNAME="$(getent passwd "$USER" | cut -d: -f5 | cut -d, -f1)"
read -e -i "$CURRENT_FULLNAME" \
  -p $'    â–¹ Your full name (optional): \033[1m' FULLNAME
printf "\033[0m\n"

# --- Apply the name ---
if [ -n "$FULLNAME" ]; then
  printf "    â–« Saving full name. "
  sudo usermod -c "$FULLNAME" "$USER"
  printf "\n\n"
fi
sleep 3	

printf "    â–« Package configuration. "
sleep 3	
...
"
  ...
  â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• \033[1mSystem will reboot now\033[0m â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
  â•‘                                                       â•‘
  â•‘   Step 1 completed successfully!                      â•‘
  â•‘                                                       â•‘
  â•‘   Reboot in: \033[1m%-2d\033[0m                                       â•‘
  â•‘                                                       â•‘
  â•‘   After reboot, run:                                  â•‘
  â•‘   \033[3m./install-gnome.sh\033[0m                                  â•‘
  â•‘                                                       â•‘
...
clear
printf "\n\n"
printf "  â•”â•â•â•â•â•â•â• \033[1mGUIDE GNOME Installer â€“ Step 2 of 3\033[0m â•â•â•â•â•â•â•â•â•â•â•â•—\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘   This step will perform system updates and basic     â•‘\n"
printf "  â•‘   preparation. You may be asked for your sudo         â•‘\n"
printf "  â•‘   password.                                           â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•Ÿâ”€â–« Configure keyboard layout                           â•‘\n"
printf "  â•Ÿâ”€â–« Configure timezone and locale                       â•‘\n"
printf "  â•Ÿâ”€â–« Update package lists                                â•‘\n"
printf "  â•Ÿâ”€â–« Remove unused packages                              â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•™â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•œ\n"
printf "\n"
sleep 1

printf "    â–¹ Press [\033[1mENTER\033[0m] to continue with Step 2, \n"
...
printf "\n"
printf "    â–« Step 2 completed successfully.\n"
...
"
  ...
  â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• \033[1mSystem will reboot now\033[0m â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
  â•‘                                                       â•‘
  â•‘   Step 2 completed successfully!                      â•‘
  â•‘                                                       â•‘
  â•‘   Reboot in: \033[1m%-2d\033[0m                                       â•‘
  â•‘                                                       â•‘
  â•‘   After reboot, run:                                  â•‘
...
clear
printf "\n\n"
printf "  â•”â•â•â•â•â•â•â• \033[1mGUIDE GNOME Installer â€“ Step 3 of 3\033[0m â•â•â•â•â•â•â•â•â•â•â•â•â•—\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘   This is the final step!                             â•‘\n"
printf "  â•‘   GNOME and related components will be installed.     â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•Ÿâ”€â–« Installing GNOME desktop environment                â•‘\n"
printf "  â•Ÿâ”€â–« Installing desktop applications                     â•‘\n"
printf "  â•Ÿâ”€â–« Applying system and user configuration              â•‘\n"
printf "  â•Ÿâ”€â–« Enabling autostart and services                     â•‘\n"
printf "  â•Ÿâ”€â–« Cleaning temporary install files                    â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•™â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•œ\n"
printf "\n\n"
sleep 1
printf "    â–¹ Press [\033[1mENTER\033[0m] to continue with Step 3, \n"
printf "      or [\033[1mCtrl\033[0m+\033[1mC\033[0m] to cancel the installation: "
read -r STEP_INPUT
...
apt update && apt install --ignore-missing -y \
  ...
  network-manager-openvpn-gnome wireguard wireguard-tools gnome-software-plugin-flatpak \
  ...
  libopengl0 rpi-imager rpi-keyboard-config rpi-keyboard-fw-update \
  dbus-x11 || true && \
...
PKGS=""; readarray -t CODES < <( { [ -f /etc/locale.gen ] && awk 'NF && $1 !~ /^#/ {print $1}' /etc/locale.gen; grep -E '^(LANG|LANGUAGE)=' /etc/default/locale 2>/dev/null | sed 's/.*=//' | tr ':' '\n'; [ -f "/var/lib/AccountsService/users/$(id -un)" ] && awk -F= '/^Language=/{print $2}' "/var/lib/AccountsService/users/$(id -un)"; [ -n "${LANG:-}" ] && echo "$LANG"; [ -n "${LANGUAGE:-}" ] && printf '%s\n' $LANGUAGE; } | sed -E 's/[[:space:]]+//g' | sed -E 's/[.@].*$//' | awk 'NF{gsub("_","-"); print tolower($0)}' | awk '!seen[$0]++' ); echo "Detected languages: ${CODES[*]}"; WANT=(hunspell hyphen libreoffice-l10n libreoffice-help); for code in "${CODES[@]}"; do echo "âž¡ Language: $code"; L="${code%%-*}"; for typ in "${WANT[@]}"; do if [ "$typ" = "libreoffice-l10n" ] && [ "$code" = "en-us" ]; then echo "  â†· skip $typ for en-us"; continue; fi; found=""; for cand in "$typ-$code" "$typ-$L"; do if apt-cache show "$cand" >/dev/null 2>&1 && ! apt-cache policy "$cand" | grep -q 'Candidate: (none)'; then found="$cand"; break; fi; done; if [ -z "$found" ]; then while read -r alt; do [[ -z "$alt" ]] && continue; [[ "$alt" =~ ^$typ- ]] || continue; if apt-cache policy "$alt" | grep -qv 'Candidate: (none)'; then found="$alt"; break; fi; done < <(apt-cache search "^$typ-$L-" | awk '{print $1}'); fi; if [ -n "$found" ]; then case " $PKGS " in *" $found "* ) : ;; * ) PKGS+=" $found"; echo "  âœ” $typ â†’ $found";; esac; else echo "  âš  No package found for $typ ($code)"; fi; done; done; if [ -n "$PKGS" ]; then echo "Installing:$PKGS"; apt-get update -y >/dev/null 2>&1 || true; for p in $PKGS; do if apt-cache madison "$p" 2>/dev/null | grep -q .; then apt-get install -y "$p" || true; else echo "  âš  Skip without candidate: $p"; fi; done; echo "Done."; else echo "Nothing to do."; fi; (dpkg -l locales-all 2>/dev/null | grep -q '^ii' && echo "â„¹ 'locales-all' is installed; we deliberately avoid 'locale -a'.") || true && \
...
"
  ...
  â•”â•â•â•â•â•â•â•â•â•â•â• \033[1mGUIDE GNOME Installer â€“ 3 of 3\033[0m â•â•â•â•â•â•â•â•â•â•â•â•â•—
  â•‘                                                       â•‘
  â•‘   GNOME installation completed successfully!          â•‘
  â•‘                                                       â•‘
  â•‘   Reboot in: \033[1m%-2d\033[0m                                       â•‘
  â•‘                                                       â•‘
  â•™â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•œ
...
printf "\n\n"
printf "  â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• \033[1mGUIDE GNOME Installer\033[0m â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘   Current step: $STEP of 3                                â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘   Enter a step number \033[1m1\033[0m-\033[1m3\033[0m to jump to that step,       â•‘\n"
printf "  â•‘   press \033[1mENTER\033[0m to continue with the current step       â•‘\n"
printf "  â•‘   or \033[1mCtrl\033[0m+\033[1mC\033[0m to cancel installer.                      â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•‘  [\033[1m1\033[0m] Sets user identity and system language.          â•‘\n"
printf "  â•‘  [\033[1m2\033[0m] Updates system, kernel, and firmware.            â•‘\n"
printf "  â•‘  [\033[1m3\033[0m] Installs GNOME desktop, themes, and apps.        â•‘\n"
printf "  â•‘                                                       â•‘\n"
printf "  â•™â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â•œ\n"
printf "\n"
sleep 1
printf "    â–¹ Press [\033[1mENTER\033[0m] to continue with Step $STEP, \n"
printf "      or [\033[1mCtrl\033[0m+\033[1mC\033[0m] to cancel the installation, \n"
...
if [[ -n "$STEP_INPUT" ]]; then
  case "$STEP_INPUT" in
    ...
    *)
      printf "\n"
      printf "    â–¹ Only option [\033[1mENTER\033[0m], [\033[1mCtrl\033[0m+\033[1mC\033[0m], [\033[1m1\033[0m], [\033[1m2\033[0m] or [\033[1m3\033[0m]. \n"
      printf "\n"
      exit 1
      ;;
  esac
...
case "$STEP" in
  ...
  COMPLETED)
    printf "\n"
    printf "    â–« Installation already completed.\n"
    ;;
  *)
    printf "\n"
    printf "    â–« Unknown installer state.\n"
    exit 1
    ;;
esac
EOF
